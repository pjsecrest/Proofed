    ...
    <main className="min-h-screen">
      <div className="mx-auto max-w-6xl px-6 pt-28 pb-24">
        <section className="animate-fade-in">
          ...
          <p className="mt-8 max-w-xxl text-lg text-[var(--muted)]">
        ...
        <section className="mt-24 border-t border-[var(--border)] pt-20"> */}
          ...
          <form className="mt-10 max-w-xl animate-fade-in-up opacity-0 [animation-fill-mode:forwards] [animation-delay:0.3s]">
